...
public class AutoUpdateService extends Service {
    ...
    private void updateWeather(){
        ...
        if(weatherString != null){
            ...
            String wearherUrl = "http://guolin.tech/api/weather?cityid="+ weatherId + "&key=4fd0d9b92a3b4806a91d368dd3767995";
            HttpUtil.sendOkHttpRequest(wearherUrl, new Callback() {
                @Override
